...
import { encodeWavStereo } from "@/lib/wav"; // ensure this file exists
...
export default function ProStudioPage() {
  ...
  useEffect(() => {
    ...
    // routing: each track -> gain -> pan -> master
    ...
    if (bypass.bass) lowShelfRef.current!.gain.value = 0;
    if (bypass.comp) compRef.current!.ratio.value = 1;
    ...
    return () => {
      clearInterval(id);
      // keep context open in dev to avoid "closed" resume errors
